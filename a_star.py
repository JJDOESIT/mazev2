...
class Node:
    def __init__(self, parent=None, position=None, end_goal=None):
        self.parent=parent
    ...
    def get_euclidean_distance(self, end_position):
    ...
    def evaluate_child_nodes(self, open_list_node):
        in_list=False
        swap_values=False
...
class A_Star_Pathfidning:
    def __init__(self, maze, start, stop, obstacle):
        self.maze=maze
        self.start=start
        self.stop=stop
    ...
    def backtrack(self, end_node, state_manager):
        temp_node=end_node
