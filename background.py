...
class Background:
    def __init__(self, screen_width, screen_height, cell_amount):
    ...
    def random_bg_value(self,col, RECT_COLOR, noise_range, distribution):
    ...
    def draw_background(self, BG_COLOR, RECT_COLOR, noise_range, distribution):
